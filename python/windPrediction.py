...
def windData():
    ...
    try:
        ...
        arr_res = np.array([plot_1x + plot_2x, plot_1y + [0 for _ in plot_2test_y], [
                           0 for _ in plot_1y] + plot_2test_y, [0 for _ in plot_1y] + plot_2predict_y])
...
@app.route("/tempPrediction", methods=['POST'])
def tempData():
    ...
    try:
        ...
        x = df[["min_temp", "max_temp", "mean_speed",
                "min_speed", "max_speed", "direction"]]
        y = df[["mean_temp"]]
